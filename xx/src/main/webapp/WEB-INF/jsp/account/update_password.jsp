...
<form name="Form2" method="post" action="account/EditLoginPassWord.html" onsubmit="return check2()">
	  <div class="selectclass">
	  	<div class="ldiv">旧密码：</div>
	 	<div class="rdiv"><input type="password"  id="Y_LoginPassWord" name="Y_LoginPassWord" class="form-control"  style="width: 15%;margin-top:8px;"/></div>
	 </div>
	 <div class="selectclass">
	  	<div class="ldiv">新密码：</div>
	 	<div class="rdiv"><input type="password"  id="X_LoginPassWord" name="X_LoginPassWord" class="form-control"  style="width: 15%;margin-top:8px;"/></div>
	 </div>
	   <div class="selectclass">
	  	<div class="ldiv">确认密码：</div>
	 	<div class="rdiv"><input type="password" id="XX_LoginPassWord" name="XX_LoginPassWord" class="form-control" style="width: 15%;margin-top:8px;"/></div>
	 </div>
